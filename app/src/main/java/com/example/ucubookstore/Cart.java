...
import com.example.ucubookstore.Model.CartM;
import com.example.ucubookstore.Prevalent.Prevalent;
import com.example.ucubookstore.ViewHolder.CartViewHolder;
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<CartM, CartViewHolder> adapter
            ...
            protected void onBindViewHolder(@NonNull CartViewHolder cartViewHolder, int i, @NonNull CartM cartM) {
                ...
                cartViewHolder.txtProductPrice.setText("Price : PHP. " + String.valueOf(oneTypeProductPrice));
