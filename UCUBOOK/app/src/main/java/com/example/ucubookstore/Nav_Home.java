...
import com.example.ucubookstore.Model.Products;
import com.example.ucubookstore.Prevalent.Prevalent;
import com.example.ucubookstore.ViewHolder.ProductViewHolder;
        ...
        FirebaseRecyclerAdapter<Products, ProductViewHolder> adapter =
                new FirebaseRecyclerAdapter<Products, ProductViewHolder>(options) {
                    ...
                    protected void onBindViewHolder(@NonNull ProductViewHolder productViewHolder, int i, @NonNull Products products) {
                        ...
                        productViewHolder.txtproductPrice.setText("Price: " + " PHP. " + products.getPrice() );
