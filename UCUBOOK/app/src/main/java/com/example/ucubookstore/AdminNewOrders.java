...
import com.example.ucubookstore.Model.AdminOrders;
...
public class AdminNewOrders extends AppCompatActivity {
        ...
        FirebaseRecyclerAdapter<AdminOrders, AdminOrdersViewholder> adapter=
                new FirebaseRecyclerAdapter<AdminOrders, AdminOrdersViewholder>(options) {
                    ...
                    protected void onBindViewHolder(@NonNull AdminOrdersViewholder adminOrdersViewholder, int i, @NonNull AdminOrders adminOrders) {
                        ...
                        adminOrdersViewholder.userTotalPrice.setText("Total Amount= PHP " + adminOrders.getTotalAmount());
    ...
    private void sendSMS(String uID) {
        ...
        String message = "Your Product order was confirmed on "+saveCurrentDate+ " at " + saveCurrentTime;
